...
A blog corresponding to this section, is now available on [Medium](https://medium.com/nerd-for-tech/building-linkedin-chat-with-smart-replies-in-flutter-eb51066c07b) and on this [website](https://imperial-lord.github.io/linkedin-clone/blog/chat-smart-replies). You can read that for a quick overview. [Follow me on Medium](https://medium.com/@absatyaprakash01) and add me to yourself to my mailing list to get mails everytime I publish new content.
